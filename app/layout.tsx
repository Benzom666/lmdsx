...
// import { Inter } from "next/font/google" // Removed due to network issues
import "./globals.css"
...
// const inter = Inter({ subsets: ["latin"] }) // Removed due to network issues
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className="font-sans"> {/* Use system font instead of Inter */}
        <ErrorBoundary>
